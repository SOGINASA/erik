...
const PATHS = {
  ...
  // Роли волонтёров на сборе: бирка с ушком — «кто чем занят».
  tag: <><path d="M4 12.5V5a1 1 0 0 1 1-1h7.5a2 2 0 0 1 1.4.6l6 6a2 2 0 0 1 0 2.8l-6.5 6.5a2 2 0 0 1-2.8 0l-6-6a2 2 0 0 1-.6-1.4z" /><circle cx="8.5" cy="8.5" r="1.4" /></>,
  ...
  // Один человек — свой профиль. Отдельно от 'users' (двое): в сайдбаре та иконка
  // уже стоит у «Моей НКО», и одинаковые значки в одном списке путали бы пункты.
  ...
  eyeOff: <><path d="M3 3l18 18M10.6 10.7a3 3 0 0 0 4.2 4.2M9.9 5.1A9.6 9.6 0 0 1 12 5c6.4 0 10 7 10 7a17 17 0 0 1-3.1 3.9M6.1 6.2A16.8 16.8 0 0 0 2 12s3.6 7 10 7a9.8 9.8 0 0 0 2.9-.4" /></>,
